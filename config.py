...
class Config:
    ...
    # Daily /api* block report at 02:30 UTC (= 08:00 IST)
    daily_report_enabled = env_bool("DAILY_REPORT_ENABLED", True)
    daily_report_hour_utc = env_int("DAILY_REPORT_HOUR_UTC", 2)
    daily_report_minute_utc = env_int("DAILY_REPORT_MINUTE_UTC", 30)
